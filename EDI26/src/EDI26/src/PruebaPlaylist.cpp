...
void pruebaRestoPlaylist(){
	...
	cout << "Hay 2 cancion/es en la lista" << endl;
	cout << "La duracion de la lista es de 0h, 5min, 11seg" << endl;
	cout << "DTMF Reggaeton 135" << endl;
	cout << "La Perla Pop 176" << endl;
	cout << "Y lo que muestra es: " << endl;
	p1->mostrar();

	cout << "Al reproducir la lista deben salir ambas canciones (DTMF y La Perla) y sale:" << endl;
	p1->reproducirTodo();

	cout << "Al reproducir desde la cancion 2 debe aparecer La Perla Pop 176 y aparece: " << endl;
